...
- `COLLECTOR_NEW_MARKET_POLL_INTERVAL_MS=10000`
- `COLLECTOR_NEW_MARKET_POLL_PAGE_SIZE=60`
- `COLLECTOR_RECONCILE_INTERVAL_MS=900000`
...
- `COLLECTOR_SNAPSHOT_PAGE_SIZE=200`
- `COLLECTOR_SNAPSHOT_MAX_PAGES=15`
- `COLLECTOR_PRUNE_INTERVAL_MS=3600000`
- `COLLECTOR_PRUNE_EXPIRED_AFTER_DAYS=7`
- `COLLECTOR_ENABLE_MISSING_MARKET_PRUNE=true`
- `COLLECTOR_MISSING_MARKET_SCAN_PAGE_SIZE=200`
- `COLLECTOR_MISSING_MARKET_SCAN_MAX_PAGES=20`
- `COLLECTOR_MISSING_MARKET_MISS_THRESHOLD=3`
- `COLLECTOR_MAX_TRACKED_MARKETS=2500`
- `COLLECTOR_MAX_TRACKED_ASSET_IDS=5000`
...
- `LIMITLESS_HTTP_TIMEOUT_MS=10000`
- `LIMITLESS_MARKETS_PAGE_SIZE=200`
- `LIMITLESS_PAGED_FETCH_CONCURRENCY=4`
- `LIMITLESS_COLLECTOR_POLL_INTERVAL_MS=10000`
- `LIMITLESS_COLLECTOR_FLUSH_INTERVAL_MS=2000`
- `LIMITLESS_COLLECTOR_RECONCILE_INTERVAL_MS=300000`
- `LIMITLESS_COLLECTOR_SNAPSHOT_LIMIT=1200`
- `LIMITLESS_COLLECTOR_HEAD_SNAPSHOT_LIMIT=400`
- `LIMITLESS_COLLECTOR_SEED_REALTIME_FROM_SNAPSHOT=true` (set `false` only if WS feed is stable and enabled)
- `LIMITLESS_COLLECTOR_CATALOG_ID_CACHE_TTL_MS=1800000`
- `LIMITLESS_COLLECTOR_PRUNE_INTERVAL_MS=3600000`
- `LIMITLESS_COLLECTOR_PRUNE_EXPIRED_AFTER_DAYS=7`
- `LIMITLESS_COLLECTOR_ENABLE_MISSING_MARKET_PRUNE=true`
- `LIMITLESS_COLLECTOR_MISSING_MARKET_SCAN_LIMIT=2500`
