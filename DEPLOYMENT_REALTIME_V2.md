...
- `LIMITLESS_COLLECTOR_FLUSH_INTERVAL_MS=5000`
- `LIMITLESS_COLLECTOR_RECONCILE_INTERVAL_MS=900000`
- `LIMITLESS_COLLECTOR_SNAPSHOT_LIMIT=200`
- `LIMITLESS_COLLECTOR_HEAD_SNAPSHOT_LIMIT=80`
