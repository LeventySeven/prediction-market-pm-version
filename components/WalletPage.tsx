  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-8 pb-24 animate-in fade-in duration-500">
      ...
      <div className="bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-8 mb-8 relative overflow-hidden shadow-sm">
        <div className="absolute top-0 right-0 p-32 bg-[#E70024] opacity-[0.05] rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
        ...
        <div className="text-center relative z-10">
            ...
            <div className="flex gap-4 justify-center">
                <button className="flex-1 bg-[#E70024] hover:opacity-90 text-white font-semibold py-2.5 px-4 rounded-md flex items-center justify-center gap-2 transition-colors text-sm shadow-sm">
                    <ArrowDownLeft size={16} />
                    {lang === 'RU' ? 'Пополнить' : 'Deposit'}
                </button>
                <button className="flex-1 bg-black hover:bg-[rgba(231,0,36,0.10)] text-[#E70024] font-semibold py-2.5 px-4 rounded-md flex items-center justify-center gap-2 transition-colors border border-[#E70024] text-sm shadow-sm">
      ...
      <div className="mb-8">
        <div className="border border-zinc-900 bg-black rounded-2xl p-5">
          ...
          <div className="text-2xl font-mono font-bold text-[#E70024]">
