        ...
        {isEditing && (
          <div className="mt-4 w-full border border-zinc-900 bg-zinc-950/30 rounded-2xl p-4 sm:p-5">
            <div className="grid grid-cols-1 gap-4">
              ...
              {editError && <div className="text-xs text-[#E50C00]">{editError}</div>}
        ...
        <div className="relative p-4">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="mt-1 text-2xl font-mono font-bold text-[#E50C00]">
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="text-right flex-shrink-0">
                            ...
                            <div className={`mt-0.5 text-[11px] font-mono ${pnlPositive ? 'text-[#E50C00]' : 'text-[#E50C00]'}`}>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right flex-shrink-0">
                        ...
                        <div className={`mt-0.5 text-[11px] font-mono ${won ? 'text-[#E50C00]' : 'text-[#E50C00]'}`}>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right flex-shrink-0">
                        ...
                        {pnl !== null ? (
                          <div className={`mt-0.5 text-[11px] font-mono ${pnl >= 0 ? 'text-[#E50C00]' : 'text-[#E50C00]'}`}>
                            {formatSignedMoney(pnl)} ({pnl >= 0 ? '+' : '-'}
                        ...
                        <div className="mt-1 inline-flex items-center justify-end gap-1 text-[10px] uppercase tracking-wider text-zinc-500">
                          {pnl !== null ? (pnl >= 0 ? <ArrowUpRight size={12} className="text-[#E50C00]" /> : <ArrowDownRight size={12} className="text-[#E50C00]" />) : null}
