            ...
            return (
                <div className="w-full bg-black border border-neutral-800 rounded-lg p-4 mb-6 relative overflow-hidden flex flex-col justify-center">
                    <div className="flex justify-between items-end mb-4">
                        <span className="text-3xl font-bold text-[rgba(190,255,29,1)]">72%</span>
                    ...
                    <div className="w-full h-2 bg-neutral-900 rounded-full flex mb-4">
                        <div className="w-[72%] h-full bg-[rgba(190,255,29,1)] shadow-[0_0_10px_rgba(190,255,29,0.25)]"></div>
            ...
            return (
              <div className="w-full flex gap-3 mb-6">
                ...
                >
                  ...
                  <span className={`text-xs font-mono ${demoPick === 'YES' ? 'text-black/70' : 'text-neutral-400'}`}>$0.72</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className={`text-xs font-mono ${demoPick === 'NO' ? 'text-white/80' : 'text-neutral-400'}`}>$0.28</span>
                </button>
              </div>
            );
        case 3: // Profit Card
            return (
                <div className="w-full bg-neutral-900/30 border border-neutral-800 rounded-lg p-4 mb-6 relative">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-neutral-800">
                        ...
                        <span className="text-xl font-bold text-[rgba(190,255,29,1)] font-mono">$138.00</span>
                    </div>
